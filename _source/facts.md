...
- **11x in 2020 ($1.6M → $17M)** · **$35M+ peak revenue** · **~$85M GMV** · **2.3M+ units** ·
  **323% revenue CAGR (2019–21)** · **EBITDA-profitable four years running; profitable today.**
...
- AI sports-intelligence platform — structured data from physical sports venues.
  **Pickleball is the wedge; the data is the business.**
- Multi-model pipeline: **Gemini (vision) + Claude (strategy)**, 2-person team.
- Live across **4 venues · 36 courts · 760 users.** Flagship **44-court expansion LOI (~$120K ARR)**
  ⚠️ signed/converted status open.
- **PRIVATE (never public site):** **$350K** raise. OK on directly-sent résumé only.
...
- Company proof: `courtana.com` · `dreamship.com`.
...
- **`$350K` raise (private):** `index.html:595` · `resume.html:135` · `resume-v2.html:209` · `climb.html:458`
