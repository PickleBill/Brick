...
(function () {
  ...
  const COMMANDS = {
    ...
    dreamship: [
      ...
      { k: 'Google', t: 'director sign-off across 5\u20136 internal teams \u00b7 8-fig channel \u00b7 ran 5+ yrs.' },
      { k: 'Scale', t: '$35M+ revenue \u00b7 11x in 2020 ($1.6M\u2192$17M) \u00b7 ~$85M GMV.' },
      { k: 'Profit', t: 'EBITDA-profitable four years running. Profitable today.' },
      { d: 'eight figures = ad spend *through* the channel \u2014 not our revenue.' }
    ],
    flywheel: [
    ...
    help: [
      ...
      { d: 'tap a chip below or type a command + Enter.' }
    ]
  };
  ...
  function typeCmd(name, cb) {
    ...
    function printOut() {
      const lines = def || [{ c: 'err', t: '\u2717 command not found: ' + cmd + '  \u00b7  try: help' }];
      let li = 0;
      function nextLine() {
        if (li >= lines.length) {
          if (OPEN[cmd]) {
